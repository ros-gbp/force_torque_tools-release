Name:           ros-indigo-gravity-compensation
Version:        1.0.2
Release:        0%{?dist}
Summary:        ROS gravity_compensation package

Group:          Development/Libraries
License:        BSD
URL:            http://wiki.ros.org/gravity_compensation
...
%description
Compensates gravity forces on the gripper of the robot so that force-torque
signals are zeroed. Assumes previously calibrated accelerometer and F/T sensor.
